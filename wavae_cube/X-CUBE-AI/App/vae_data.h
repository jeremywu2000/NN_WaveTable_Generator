...
AI_DEPRECATED
#define AI_VAE_DATA_ACTIVATIONS(ptr_)  \
  ai_vae_data_activations_buffer_get(AI_HANDLE_PTR(ptr_))

AI_DEPRECATED
#define AI_VAE_DATA_WEIGHTS(ptr_)  \
  ai_vae_data_weights_buffer_get(AI_HANDLE_PTR(ptr_))


AI_API_DECLARE_BEGIN


extern const ai_u64 s_vae_weights_array_u64[1193];
