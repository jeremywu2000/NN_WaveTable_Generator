...
#define AI_SINE_MODEL_MODEL_SIGNATURE     "6a3ddd0109779e8f4e06b51298e85f48"
...
#define AI_TOOLS_DATE_TIME   "Sat Feb 11 22:30:21 2023"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_sine_model_activations_map, 1, params)) {
    ...
    serving_default_dense_6_input0_output_array.data = AI_PTR(g_sine_model_activations_map[0] + 60);
    serving_default_dense_6_input0_output_array.data_start = AI_PTR(g_sine_model_activations_map[0] + 60);
