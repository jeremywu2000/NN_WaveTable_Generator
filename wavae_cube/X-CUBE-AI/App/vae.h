...
#define AI_VAE_ORIGIN_MODEL_NAME   "keras_vae_20230403135924"

/******************************************************************************/
#define AI_VAE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_VAE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_VAE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_VAE_IN_NUM        (1)

AI_DEPRECATED
#define AI_VAE_IN \
  ai_vae_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_VAE_IN_SIZE { \
  AI_VAE_IN_1_SIZE, \
}
#define AI_VAE_IN_SIZE_BYTES { \
  AI_VAE_IN_1_SIZE_BYTES, \
}
#define AI_VAE_IN_1_HEIGHT      (1)
#define AI_VAE_IN_1_WIDTH       (16)
#define AI_VAE_IN_1_CHANNEL     (1)
#define AI_VAE_IN_1_SIZE        (1 * 16 * 1)
#define AI_VAE_IN_1_SIZE_BYTES  (64)

/******************************************************************************/
#define AI_VAE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_VAE_OUT \
  ai_vae_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_VAE_OUT_SIZE { \
  AI_VAE_OUT_1_SIZE, \
}
#define AI_VAE_OUT_SIZE_BYTES { \
  AI_VAE_OUT_1_SIZE_BYTES, \
}
#define AI_VAE_OUT_1_HEIGHT      (1)
#define AI_VAE_OUT_1_WIDTH       (256)
#define AI_VAE_OUT_1_CHANNEL     (1)
#define AI_VAE_OUT_1_SIZE        (1 * 256 * 1)
 ...
 * @ref ai_vae_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_VAE_*
 * defines into file @ref vae.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
