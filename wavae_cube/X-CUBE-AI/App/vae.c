...
AI_ARRAY_OBJ_DECLARE(
  conv2dT_1_conv2d_bias_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Array#3 */
AI_ARRAY_OBJ_DECLARE(
  decoder_output_conv2d_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Array#7 */
AI_ARRAY_OBJ_DECLARE(
  conv2dT_1_conv2d_weights_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Array#10 */
AI_ARRAY_OBJ_DECLARE(
  conv2dT_1_conv2d_upsample_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 4064, AI_STATIC)
/* Array#11 */
AI_ARRAY_OBJ_DECLARE(
  conv2dT_1_conv2d_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 2048, AI_STATIC)
/**  Tensor declarations section  *********************************************/
/* Tensor #0 */
AI_TENSOR_OBJ_DECLARE(
  conv2dT_1_conv2d_bias, AI_STATIC,
  0, 0x0,
  AI_SHAPE_INIT(4, 1, 16, 1, 1), AI_STRIDE_INIT(4, 4, 4, 64, 64),
  1, &conv2dT_1_conv2d_bias_array, NULL)
...
/* Tensor #7 */
AI_TENSOR_OBJ_DECLARE(
  conv2dT_1_conv2d_weights, AI_STATIC,
  7, 0x0,
  AI_SHAPE_INIT(4, 32, 4, 1, 16), AI_STRIDE_INIT(4, 4, 128, 512, 512),
  1, &conv2dT_1_conv2d_weights_array, NULL)
...
/* Tensor #11 */
AI_TENSOR_OBJ_DECLARE(
  conv2dT_1_conv2d_upsample_output, AI_STATIC,
  11, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 127, 1), AI_STRIDE_INIT(4, 4, 4, 128, 16256),
  1, &conv2dT_1_conv2d_upsample_output_array, NULL)

/* Tensor #12 */
AI_TENSOR_OBJ_DECLARE(
  conv2dT_1_conv2d_output, AI_STATIC,
  12, 0x0,
  AI_SHAPE_INIT(4, 1, 16, 128, 1), AI_STRIDE_INIT(4, 4, 4, 64, 8192),
  1, &conv2dT_1_conv2d_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2dT_1_conv2d_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &decoder_output_conv2d_upsample_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_LAYER_OBJ_DECLARE(
  decoder_output_conv2d_upsample_layer, 3,
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  conv2dT_1_conv2d_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2dT_1_conv2d_upsample_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2dT_1_conv2d_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv2dT_1_conv2d_weights, &conv2dT_1_conv2d_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  conv2dT_1_conv2d_layer, 2,
  CONV2D_TYPE, 0x0, NULL,
  conv2d, forward_conv2d,
  &conv2dT_1_conv2d_chain,
...
AI_STATIC_CONST ai_float conv2dT_1_conv2d_upsample_scales_data[] = { 1, 2, 1.0, 1 };
AI_ARRAY_OBJ_DECLARE(
    conv2dT_1_conv2d_upsample_scales, AI_ARRAY_FORMAT_FLOAT,
    conv2dT_1_conv2d_upsample_scales_data, conv2dT_1_conv2d_upsample_scales_data, 4, AI_STATIC_CONST)
AI_TENSOR_CHAIN_OBJ_DECLARE(
  conv2dT_1_conv2d_upsample_chain, AI_STATIC_CONST, 4,
...
AI_LAYER_OBJ_DECLARE(
  conv2dT_1_conv2d_upsample_layer, 2,
  UPSAMPLE_TYPE, 0x0, NULL,
  upsample, forward_upsample,
  &conv2dT_1_conv2d_upsample_chain,
  NULL, &conv2dT_1_conv2d_layer, AI_STATIC, 
  .scales = &conv2dT_1_conv2d_upsample_scales, 
  .center = false, 
  .mode = AI_UPSAMPLE_ZEROS, 
  .nearest_mode = AI_ROUND_PREFER_CEIL, 
)
...
AI_LAYER_OBJ_DECLARE(
  decoder_dense_1_dense_layer, 0,
  DENSE_TYPE, 0x0, NULL,
  dense, forward_dense,
  &decoder_dense_1_dense_chain,
  NULL, &conv2dT_1_conv2d_upsample_layer, AI_STATIC, 
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_VAE_OUT_NUM, &decoder_output_conv2d_output),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_vae_activations_map, 1, params)) {
    ...
    conv2dT_1_conv2d_upsample_output_array.data = AI_PTR(g_vae_activations_map[0] + 64);
    conv2dT_1_conv2d_upsample_output_array.data_start = AI_PTR(g_vae_activations_map[0] + 64);
    
    conv2dT_1_conv2d_output_array.data = AI_PTR(g_vae_activations_map[0] + 16320);
    conv2dT_1_conv2d_output_array.data_start = AI_PTR(g_vae_activations_map[0] + 16320);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_vae_weights_map, 1, params)) {
    ...
    conv2dT_1_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2dT_1_conv2d_bias_array.data = AI_PTR(g_vae_weights_map[0] + 0);
    conv2dT_1_conv2d_bias_array.data_start = AI_PTR(g_vae_weights_map[0] + 0);
    
    decoder_output_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    decoder_output_conv2d_bias_array.data = AI_PTR(g_vae_weights_map[0] + 64);
    decoder_output_conv2d_bias_array.data_start = AI_PTR(g_vae_weights_map[0] + 64);
    
    decoder_dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    decoder_dense_1_dense_weights_array.data = AI_PTR(g_vae_weights_map[0] + 68);
    decoder_dense_1_dense_weights_array.data_start = AI_PTR(g_vae_weights_map[0] + 68);
    
    decoder_dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    decoder_dense_1_dense_bias_array.data = AI_PTR(g_vae_weights_map[0] + 580);
    decoder_dense_1_dense_bias_array.data_start = AI_PTR(g_vae_weights_map[0] + 580);
    
    decoder_output_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    decoder_output_conv2d_weights_array.data = AI_PTR(g_vae_weights_map[0] + 1092);
    decoder_output_conv2d_weights_array.data_start = AI_PTR(g_vae_weights_map[0] + 1092);
    
    conv2dT_1_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2dT_1_conv2d_weights_array.data = AI_PTR(g_vae_weights_map[0] + 1348);
    conv2dT_1_conv2d_weights_array.data_start = AI_PTR(g_vae_weights_map[0] + 1348);
